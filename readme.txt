...
NOTE: There's a slight usage thing I need to fix, but for the preset pallettes to show up, you must go into the Site Dashboard at least once and hit Save so that the 4 presets I have provided will get saved to the database.
